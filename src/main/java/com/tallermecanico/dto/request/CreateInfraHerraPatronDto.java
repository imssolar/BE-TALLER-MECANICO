...
public class CreateInfraHerraPatronDto {

    @NotBlank(message = "El id de infraestructura es requerido")
    @Size(max = 25, message = "El id de infraestructura no debe exceder los 25 caracteres")
    ...
    // Constructors
    public CreateInfraHerraPatronDto() {
    }

    public CreateInfraHerraPatronDto(String idInfra, Integer idTerminal, String modelo, String serie,
                                     String marca, String descripcion, Integer anio, String responsable,
                                     String tipo, LocalDate fechaCalibracion, LocalDate fechaVigencia,
                                     String periodo) {
