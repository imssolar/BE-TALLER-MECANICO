...
public class CreatePautaOTPDto {

    @NotBlank(message = "La pauta OTP es requerida")
    @Size(max = 50, message = "La pauta OTP no debe exceder los 50 caracteres")
